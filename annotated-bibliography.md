...
## Elder, R. Bruce. "The Cinema We Need" and "A Vindication." _Documents in Canadian Film_. Ed. Douglas Fetherling. Peterborough: Broadview Press, 1988.
...
First, the argument of images as "significant surfaces" that abstract the world "'out there' in space and time," which require an element of activity on the part of the viewer, an image/human coupling: "If one wishes to deepen the significance, i.e. to reconstruct the abstracted dimensions, one has to allow one's gaze to wander over the surface feeling the way as one goes. This wandering over the surface of the image is called 'scanning'. In so doing, one's gaze follows a complex path formed, on the one hand, by the structure of the image and, on the other, by the observer's intentions. The significance of the image as revealed in the process of scanning therefore represents a synthesis of two intentions: one manifested in the image and the other belonging to the observer" (8).

My goal is to appropriate this idea of "significant surfaces" and rework it as "insignificant surfaces" (not "a-signficant"), which emphaizes, rather than the predominantly symbolic and abstracting character of the image within a system of "encoding" and "decoding" (10)&em;the "synthesis of intention"&em;but instead a localized modulation, systems of _minor_ intensities between between viewer and image, which perturb and interact with each other at some level but don't necessarily communicate or synthesize. In other words, a slight shift from Flusser's model of informatics to one of energetics.

Secondly, Flusser's somewhat different (from Agamben) conception of the _apparatus_ and its relationship to information: "Tools and machines work by tearing objects from the natural world and informing them, i.e. changing the world. But apparatuses do not work in that sense. Their intention is not to change the world but to change the meaning of the world. Their intention is symbolic... Therefore in cultural analysis the category 'work' must be replaced by the category 'information'" (25).

Connected with this, Flusser's concept of the "program," which is actually a network of programs that determine the possibilities and symbolics of technical images and technologies. Within Flusser's model, for me, is the importance of creative and explicitly "experimental" practice. "The camera produces symbols: symbolic surfaces that have in a certain way been prescribed for it. The camera is programmed to produce photographs, and every photograph is a realization of one of the possibilities contained within the program of the camera... Photographers endeavour to exhaust the photographic program by realizing all their possibilities. But this program is rich and there is no way of getting an overview of it. Thus photographers attempt to find the possibilities not yet discovered within it" (26). It's not a question of novelty, since this is already fully expressed within the program of the camera: "Photographs permanently displacing one another according to a program are redundant pre- cisely because they are always 'new', precisely because they automatically exhaust the possibilities of the photographic program. This is therefore also the challenge for the photographer: to oppose the flood of redundancy with informative images" (65). Here, again, my shift is from "redundancy" and "information" to lenses: the role of the image artist is to transform bodies, to image programs whose nature is more visible, more mutable in the hands of the artist and viewer.

Finally, the paradoxical reality of images (and their hence their bodies): "It is not the world out there that is real, nor is the concept within the camera's program - only the photograph is real" (37).

"Image-apparatus-program-information. These must be the cornerstones of any philosophy of photography, and they make possible the following definition of a photograph: It is an image created and distributed by photographic apparatus according to a program, an image whose ostensible function is to inform. Each one of the basic concepts thus contains within it further concepts. Image contains within it magic; apparatus contains within it automation and play; program contains within it chance and necessity; information contains within it the symbolic and the improbable" (76). Image-apparatus-program-transformation, an effort to flip the reversal of human/technology relations back towards one which is rooted in our fleshly bodies and their potentials, rather than "machines.. as models of human beings, of the world and of society" (78).
